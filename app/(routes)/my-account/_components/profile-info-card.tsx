...
export const ProfileInfoCard = ({ displayProfile }: ProfileInfoCardProps) => {
  return (
    <div className="container mx-auto px-4 space-y-8">
      <Card className="bg-transparent p-8 px-4 rounded-[3rem]">
        <CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  readOnly
                  className="w-full px-4 py-3 bg-transparent border border-pink-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-pink-500/50 transition-colors disabled:border-pink-500/65"
